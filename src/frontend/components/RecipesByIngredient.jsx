...
import { getRecipesByIngredient } from '../../backend/api/explore-backend';
import IdComponent from '../components/SingleRecipe';
import { useState } from 'react';



const IngredientComponent = ({ selectedIngredient }) => {
    const recipes = getRecipesByIngredient(selectedIngredient);
    ...
    if(idPageVisible){
        ...
        <h1>{selectedIngredient} Recipes:</h1>
        <br />
